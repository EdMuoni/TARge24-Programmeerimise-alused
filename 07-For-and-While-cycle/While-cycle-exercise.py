...
def ask_user_age(age_limit: int) -> int:
    ...
    # Test case with age_limit set to 20


if __name__ == "__main__":
    print(make_hola_string(3), "==holaholahola")  # => "holaholahola"
    print(make_hola_string(0), "==")  # => ""
    print(generate_string_with_random_length(
        0.5))  # =>"-" (usually empty or 1 minus)
    print(
        generate_string_with_random_length(0.9))  # => "-----" (result can vary)
    print(ask_user_age(20))
